...
DD=/scratch/$MyID/BirdRNAseq/RawData                          ## Example: DD=/scratch/$MyID/PracticeRNAseq/RawData
CD=/scratch/$MyID/BirdRNAseq/CleanData                          ## Example: CD=/scratch/$MyID/PracticeRNAseq/CleanData
PCQ=BirdPostCleanQuality
