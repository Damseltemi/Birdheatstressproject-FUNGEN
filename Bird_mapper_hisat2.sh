...
MyID=aubclsc0325          ## Example: MyID=aubtss

WD=/scratch/$MyID/BirdRNAseq                                                ## Example:/scratch/$MyID/PracticeRNAseq  
CD=/scratch/$MyID/BirdRNAseq/CleanData                                            ## Example:/scratch/$MyID/PracticeRNAseq/CleanData20   #   *** This is where the cleaned paired files are located
REFD=/scratch/$MyID/BirdRNAseq/GCF_000002315.6_GRCg6a_genomic                                               ## Example:/scratch/$MyID/PracticeRNAseq/DaphniaRefGenome_6                      # this directory contains the indexed reference genome for the garter snake
MAPD=/scratch/$MyID/BirdRNAseq/Map_HiSat2                                              ## Example:/scratch/$MyID/PracticeRNAseq/Map_HiSat2_6
COUNTSD=/scratch/$MyID/BirdRNAseq/Counts_StringTie                                           ## Example:/scratch/$MyID/PracticeRNAseq/Counts_StringTie_6

RESULTSD=/home/$MyID/BirdRNAseq/Counts_H_S_2024                                    ## Example:/home/aubtss/PracticeRNAseq/Counts_H_S_6

REF=GCF_000002315.6_GRCg6a_genomic
...
cd ${REFD}
cp /scratch/aubclsc0325/GCF_000002315.6_GRCg6a_genomic.fna .
cp /scratch/aubclsc0325/GCF_000002315.6_GRCg6a_genomic.gtf .
###  Identify exons and splice sites on the reference genome
#gffread ${REF}.gff3 -T -o ${REF}.gft               ## gffread converts the annotation file from .gff3 to .gft formate for HiSat2 to use.
...
hisat2-build --ss $REF.ss --exon $REF.exon $REF.fna Chick_index
