...
MyID=aubclsc0325          ## Example: MyID=aubtss
 ...
 DD=/scratch/$MyID/BirdRNAseq/RawData1  			## Example: DD=/scratch/$MyID/PracticeRNAseq/RawData
WD=/scratch/$MyID/BirdRNAseq				## Example: WD=/scratch/$MyID/PracticeRNAseq
RDQ=BirdRawDataQuality1
...
fastq-dump -F --split-files ERR2984227
fastq-dump -F --split-files ERR2984234
fastq-dump -F --split-files ERR2984226
fastq-dump -F --split-files ERR2984231
fastq-dump -F --split-files ERR2984238
fastq-dump -F --split-files ERR2984246
fastq-dump -F --split-files ERR2984239
fastq-dump -F --split-files ERR2984245
##### Extra ####
